...
async function initMap() {
  // 初期位置 東京駅
  // posts#showでは投稿の1個目の座標にするのが良さそう
  ...
  try {
    ...
    const response = await fetch(`/maps/${maptestId}.json`);
    ...
    items.forEach( item => {
      ...
      const marker = new google.maps.marker.AdvancedMarkerElement ({
        ...
        title: title,
        // body: body,
        // 他の任意のオプションもここに追加可能 どう書くのかを調べよう
      });
    ...
    console.error('Error fetching or processing map tests:', error);
  }
}
